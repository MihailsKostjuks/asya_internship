...
# Flux: many storages, singleton dispatcher, mutable states
# Redux: implemented on Flux basis. One storage, no dispatcher, immutable states


# my_thread.start() just adds this thread along the main thread and any other threads and they execute concurrently
