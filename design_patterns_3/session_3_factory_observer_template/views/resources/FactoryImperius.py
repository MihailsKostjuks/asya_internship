    ...
    def create_actor(self, enum_actor: EnumActor) -> pygame.Surface:
        ...
        try:
            if enum_actor == EnumActor.Warrior:
                result = pygame.image.load('resources/Tribes/Imperius/Units/warrior.png')
...
if __name__ == '__main__':  # need to delete resources/ from image path
    factory = ResourceFactoryImperius()
    factory.create_building(EnumBuilding.City, 5)